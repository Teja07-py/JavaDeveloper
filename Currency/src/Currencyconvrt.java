...
public class Currencyconvrt extends javax.swing.JFrame {
    ...
    double Pakistani_Rupee = 162.74;
        ...
        public static void main(String args[]) {
            ...
            try {
                ...
                java.util.logging.Logger.getLogger(Currencyconvrt.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
            ...
            java.awt.EventQueue.invokeLater(new Runnable() {
                public void run() {
                    new Currencyconvrt().setVisible(true);
                }
            });
        }
